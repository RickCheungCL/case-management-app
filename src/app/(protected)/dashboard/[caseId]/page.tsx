            ...
            <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                          caseData.status === 'New' ? 'bg-yellow-100 text-yellow-800' : 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-md font-bold text-gray-800">{new Date(caseData.createdAt).toLocaleDateString()}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg border border-gray-200 p-4">
                ...
                <div className="flex flex-wrap gap-2">
                  <button onClick={() => setActiveTab('viewDocs')} className="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    View Documents
                  </button>
                  <button onClick={() => setActiveTab('viewPhotos')} className="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    View Photos
                  </button>
                  <button onClick={() => setIsLinkExpanded(!isLinkExpanded)} className="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <li key={doc.id} className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      <div className="flex items-center">
                        ...
                        <a href={doc.url} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-800 font-medium">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {caseData.photos.map((photo) => (
                  <div key={photo.id} className="bg-gray-50 border border-gray-200 rounded-lg overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {isEditingContact ? (
                    ...
                    <>
                      <div className="space-y-4">
                        <div>
                          <label className="text-sm font-medium text-gray-500 mb-1 block">Organization Name</label>
                          <input
                            type="text"
                            value={editedContactInfo.schoolName}
                            onChange={(e) => setEditedContactInfo({...editedContactInfo, schoolName: e.target.value})}
                            className="w-full border border-gray-300 rounded-md p-2 text-gray-700"
                          />
                        </div>
                        <div>
                          <label className="text-sm font-medium text-gray-500 mb-1 block">Contact Person</label>
                          <input
                            type="text"
                            value={editedContactInfo.contactPerson}
                            onChange={(e) => setEditedContactInfo({...editedContactInfo, contactPerson: e.target.value})}
                            className="w-full border border-gray-300 rounded-md p-2 text-gray-700"
                          />
                        </div>
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setEditedContactInfo({...editedContactInfo, emailAddress: e.target.value})}
                            className="w-full border border-gray-300 rounded-md p-2 text-gray-700"
                          />
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setEditedContactInfo({...editedContactInfo, phoneNumber: e.target.value})}
                            className="w-full border border-gray-300 rounded-md p-2 text-gray-700"
                          />
                        </div>
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) => setEditedContactInfo({...editedContactInfo, schoolAddress: e.target.value})}
                            className="w-full border border-gray-300 rounded-md p-2 text-gray-700"
                            rows={3}
                          />
                        </div>
                    ...
                    <>
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-800 font-medium">{caseData.contactPerson || '—'}</p>
                        </div>
                        <div>
                          <h4 className="text-sm font-medium text-gray-500 mb-1">Email Address</h4>
                          {caseData.emailAddress ? (
                            <p className="text-gray-800 font-medium">
                              <a href={`mailto:${caseData.emailAddress}`} className="text-indigo-600 hover:text-indigo-800">
                                {caseData.emailAddress}
                              </a>
                            </p>
                          ) : (
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          {caseData.phoneNumber ? (
                            <p className="text-gray-800 font-medium">
                              <a href={`tel:${caseData.phoneNumber}`} className="text-indigo-600 hover:text-indigo-800">
                                {caseData.phoneNumber}
                              </a>
                            </p>
                          ) : (
                        ...
                        <div>
                          ...
                          <p className="text-gray-800 font-medium whitespace-pre-line">{caseData.schoolAddress || '—'}</p>
                        </div>
                      </div>
                    </>
                  )}
              ...
              <div className="mb-8">
                ...
                <div className="bg-gray-50 rounded-lg border border-gray-200 p-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                      { id: 'num2FtLinearHighBay', label: '2 Ft Linear High Bay', value: caseData.num2FtLinearHighBay },
                      { id: 'num150WUFOHighBay', label: '150W UFO High Bay', value: caseData.num150WUFOHighBay },
                      { id: 'num240WUFOHighBay', label: '240W UFO High Bay', value: caseData.num240WUFOHighBay },
                      { id: 'num2x2LEDPanel', label: '2x2 LED Panel', value: caseData.num2x2LEDPanel },
                      { id: 'num2x4LEDPanel', label: '2x4 LED Panel', value: caseData.num2x4LEDPanel },
                      { id: 'num1x4LEDPanel', label: '1x4 LED Panel', value: caseData.num1x4LEDPanel },
                      { id: 'num4FtStripLight', label: '4 Ft Strip Light', value: caseData.num4FtStripLight }
                    ].map((fixture) => (
                      <div key={fixture.id} className="flex justify-between p-3 bg-white rounded border border-gray-200">
                        <span className="text-gray-700">{fixture.label}</span>
                        {isEditingLighting ? (
                          <input
                            type="number"
                            min="0"
                            value={editedFixtureCounts[fixture.id as keyof typeof editedFixtureCounts]}
                            onChange={(e) => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {isEditingLighting ? (
                    ...
                    <>
                      <div className="space-y-4">
                        <div>
                          <label className="text-sm font-medium text-gray-500 mb-1 block">Lighting Purpose</label>
                          <input
                            type="text"
                            value={editedLightingSpecs.lightingPurpose}
                            onChange={(e) => setEditedLightingSpecs({...editedLightingSpecs, lightingPurpose: e.target.value})}
                            className="w-full border border-gray-300 rounded-md p-2 text-gray-700"
                          />
                        </div>
                        <div>
                          <label className="text-sm font-medium text-gray-500 mb-1 block">Facilities Used In</label>
                          <input
                            type="text"
                            value={editedLightingSpecs.facilitiesUsedIn}
                            onChange={(e) => setEditedLightingSpecs({...editedLightingSpecs, facilitiesUsedIn: e.target.value})}
                            className="w-full border border-gray-300 rounded-md p-2 text-gray-700"
                          />
                        </div>
                      </div>
                      <div>
                        <div>
                          <label className="text-sm font-medium text-gray-500 mb-1 block">Installation Service</label>
                          <select
                            value={editedLightingSpecs.installationService}
                            onChange={(e) => setEditedLightingSpecs({...editedLightingSpecs, installationService: e.target.value})}
                            className="w-full border border-gray-300 rounded-md p-2 text-gray-700"
                          >
                    ...
                    <>
                      <div className="space-y-4">
                        <div>
                          <h4 className="text-sm font-medium text-gray-500 mb-1">Lighting Purpose</h4>
                          <p className="text-gray-800 font-medium">{caseData.lightingPurpose || '—'}</p>
                        </div>
                        <div>
                          <h4 className="text-sm font-medium text-gray-500 mb-1">Facilities Used In</h4>
                          <p className="text-gray-800 font-medium">{caseData.facilitiesUsedIn || '—'}</p>
                        </div>
                      </div>
                      <div>
                        <div>
                          <h4 className="text-sm font-medium text-gray-500 mb-1">Installation Service</h4>
                          <p className="text-gray-800 font-medium">
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                              caseData.installationService === 'Yes' ? 'bg-green-100 text-green-800' : 
                              caseData.installationService === 'No' ? 'bg-red-100 text-red-800' : 
